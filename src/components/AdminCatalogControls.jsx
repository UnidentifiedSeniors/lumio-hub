...
function AdminCatalogControls({ onUpdated }) {
  ...
  const readCatalogFile = async (event, kind) => {
    ...
    const label = kind === "champions" ? "champion" : kind === "values" ? "Lumio value" : "trait";
